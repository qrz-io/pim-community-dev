...
Feature: Validate localized metric attributes of a product
  ...
  Background:
    ...
    And the following attributes:
      | code   | label-fr_FR | type   | scopable | metric_family | default_metric_unit | negative_allowed | decimals_allowed | number_min | number_max |
      | area   | Zone        | metric | no       | Area          | HECTARE             | no               | no               |            |            |
      | length | Taille      | metric | yes      | Length        | METER               | no               | no               |            |            |
      | power  | Puissance   | metric | no       | Power         | WATT                | yes              | yes              | -200       | -100       |
      | speed  | Vitesse     | metric | yes      | Speed         | YARD_PER_HOUR       | yes              | yes              | 5.50       | 100        |
