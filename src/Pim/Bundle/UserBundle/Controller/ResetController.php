...
class ResetController extends Controller
{
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        if (null === $user) {
            return $this->render('PimUserBundle:Reset:request.html.twig', array('invalid_username' => $username));
        }
        ...
        $message = \Swift_Message::newInstance()
            ...
            ->setTo($user->getEmail())
            ->setBody(
                $this->renderView('PimUserBundle:Mail:reset.html.twig', array('user' => $user)),
                'text/html'
            );
